...
const DIMS = [
  ...
  { key: 'status', col: 3, label: '出口', agg: '出口を問わず', def: '登記記録の閉鎖事由（国税庁）と、EDINETの上場区分・書類履歴（金融庁）から判定。「存続（休眠含む）」は登記が閉鎖されておらず上場歴もない会社。休眠したまま登記が残っている会社を含むため、実際に事業を続けている会社の数より多い。' },
